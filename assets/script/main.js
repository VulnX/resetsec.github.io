    ...
    function handleCommand(rawInput) {
        ...
        switch (base) {
            case 'help':
                ...
                term.writeln("  echo [args]    Print arguments to stdout (supports $VARS)");
            ...
            case 'echo':
                const expanded = args.map(arg =>
                    arg.startsWith('$') ? (env[arg.slice(1)] ?? '') : arg
                ).join(" ");
